    ...
    try {
      ...
      if (data) {
        res
          ...
          .json(successAction(STATUS_CODE.SUCCESS, data, MESSAGE.add('Book')))
      } else {
  ...
  public static async getBookById(req: Request, res: Response) {
    try {
      ...
      if (!findBook) {
        res
          ...
          .json(
            failAction(
              STATUS_CODE.SUCCESS,
              MESSAGE.notExist('Book not existed'),
            ),
          )
      }
      ...
      res
        .status(STATUS_CODE.SUCCESS)
        .json(
          successAction(STATUS_CODE.SUCCESS, findBook, MESSAGE.fetch('Store')),
        )
    } catch (err: any) {
      ...
      res
        ...
        .json(
          successAction(
            STATUS_CODE.SUCCESS,
            bookData,
            MESSAGE.fetch('Book are fetched successufully'),
          ),
        )
    } catch (err: any) {
        ...
        res
          ...
          .json(
            successAction(
              STATUS_CODE.SUCCESS,
              data,
              MESSAGE.update('Book updated successfully'),
            ),
          )
      }
    } catch (err: any) {
    ...
    try {
      ...
      res
        ...
        .json(
          successAction(
            STATUS_CODE.SUCCESS,
            MESSAGE.delete('Book is soft deleted successfully:'),
          ),
        )
    } catch (err: any) {
